...
Middle Frontend Developer · Angular · TypeScript · 3,5+ года коммерческого опыта.

Разрабатываю enterprise SPA на Angular 15+ с реактивным ядром на RxJS/NgRx. Владею стеком React + Redux Toolkit и Vue 3 + Pinia + Nuxt — использовал в коммерческих проектах.

Сильные стороны: производительность (OnPush, lazy loading, code splitting, Core Web Vitals), архитектура (модульность, дизайн-системы, интеграция OpenAPI-схем), тестирование (Jest, Cypress), инфраструктура сборки (Vite, Webpack), CI/CD в GitLab.

Работал в телеком-продукте с аудиторией 100 000+ пользователей и в аутсорс-компании над проектами для клиентов из СНГ и Ближнего Востока. В команде — Scrum, Jira, регулярное код-ревью, наставничество джунов.
